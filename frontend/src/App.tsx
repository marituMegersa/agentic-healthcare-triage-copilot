...
export default function App() {
  ...
  return (
    <div style={{ padding: '2rem', fontFamily: 'sans-serif', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Agentic AI Healthcare Triage & Guideline Copilot</h1>
      <p style={{ color: '#666' }}>Multi-agent clinical triage, WHO guideline RAG, and emergency referral decision-support system.</p>
