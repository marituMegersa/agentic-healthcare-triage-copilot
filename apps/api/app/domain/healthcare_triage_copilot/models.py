...
class AgenticHealthcareTriageCopilotSession(Base):
    __tablename__ = "healthcare_triage_copilot_sessions"
...
class AgenticHealthcareTriageCopilotItem(Base):
    __tablename__ = "healthcare_triage_copilot_items"

    id = Column(String, primary_key=True, index=True)
    session_id = Column(String, ForeignKey("healthcare_triage_copilot_sessions.id"))
